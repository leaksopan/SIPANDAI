...
const StaffApplicationForm = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!formData.nama || !formData.jabatan || !formData.section) {
    ...
    try {
      ...
      setSuccess(true);
      setFormData({ nama: '', jabatan: '', section: '' });
    } catch (err) {
        ...
        <div style={{
          ...
          <div>
            ...
            <p style={{
              ...
              Aplikasi Anda untuk menjadi staff telah dikirim dan sedang menunggu persetujuan dari Super Admin atau Kepala Bidang.
            </p>
          </div>
      ...
      <form onSubmit={handleSubmit} style={{
        ...
        <div>
          ...
          <input
            ...
            onChange={handleInputChange}
            placeholder="Contoh: Analyst, Coordinator, Specialist"
            style={{
              width: '100%',
              padding: '12px 16px',
              border: '1px solid #d1d5db',
